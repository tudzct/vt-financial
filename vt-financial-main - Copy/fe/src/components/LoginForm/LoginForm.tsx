...
const LoginForm = () => {
  ...
  const handleLogin = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (status === 400) {
        setFormError(apiMessage || 'Bad Request')
      } else if (status === 401) {
              ...
              <div className="flex flex-col gap-6">
                <div>
                  ...
                  <input
                    ...
                    className={`h-12 w-full rounded-[8px] border bg-transparent px-4 py-3 text-base leading-6 text-[#4b5768] outline-none transition placeholder:text-[#4b5768] focus:border-[#4b5768] focus:ring-1 focus:ring-[#4b5768] disabled:cursor-not-allowed disabled:opacity-60 ${
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className={`h-12 w-full rounded-[8px] border bg-transparent px-4 py-3 pr-12 text-base leading-6 text-[#4b5768] outline-none transition placeholder:text-[4px] placeholder:tracking-[4px] placeholder:text-[#999da3] focus:border-[#4b5768] focus:ring-1 focus:ring-[#4b5768] disabled:cursor-not-allowed disabled:opacity-60 ${
